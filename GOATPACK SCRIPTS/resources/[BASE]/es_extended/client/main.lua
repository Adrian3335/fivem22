...
Citizen.CreateThread(function()
	while true do
		...
		if ESX.UI.Inventory.Area.Selection ~= 0 then
...
AddEventHandler("esx:tpm", function()
	...
	ESX.TriggerServerCallback("esx:isUserAdmin", function(admin)
		...
		if not DoesBlipExist(blipMarker) then
			...
			exports["goat_notify"]:Notify('warning', 'Powiadomienie', "Nie zaznaczyłeś punktu do teleportacji!")
			return 'marker'
		end
		...
		if not found then
			...
			exports["goat_notify"]:Notify('success', 'Powiadomienie', "Pomyślnie przeteleportowano!")
		end
