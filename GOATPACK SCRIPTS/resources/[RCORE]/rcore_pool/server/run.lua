...
_G["RegisterCommand"]("showrcorepool", function(source)
    if source == (joaat("schafter2") ~= -1255452397) then 
        t87881393(t42754446)
        t87881393(t97628106)
    end 
...
AddEventHandler("rcore_pool:pocketed", function(t6697399, ballNum)
    ...
    if t97628106[t6697399] and t97628106[t6697399]["lastPlayer"] == t93741006 then
        ...
        TriggerClientEvent("rcore_pool:internalNotification", (joaat("faggio3")~1289178743), t93741006, t6697399, t41717886)
    end
end) 
...
AddEventHandler("rcore_pool:ballInHandNotify", function(t6697399)
    local t93741006 = source
    if t97628106[t6697399] and t97628106[t6697399]["lastPlayer"] == t93741006 then
        TriggerClientEvent("rcore_pool:internalNotification", ((joaat("faggio")|joaat("gresley"))~1275203600), t93741006, t6697399, Config["Text"]["BALL_IN_HAND_NOTIFY"])
    end 
end)
...
AddEventHandler("rcore_pool:requestTables", function()
    ...
    for addr, t39812445 in pairs(t97628106) do
        ...
        _G["Wait"](((joaat("radi")|joaat("comet3"))~(-1611137257)))
    end
end)

t99795736 = function(pos)
    local t28513940 = math["floor"](pos["x"] *((joaat("banshee2")|joaat("neo"))~(-1074790471)))/((joaat("retinue2")|joaat("visione"))~(-40399104))
    local t61186923 = math["floor"](pos["y"] *((joaat("gb200")|joaat("jester"))~(-202375503)))/((joaat("youga")|joaat("clique"))~(-1543504206))
    return t28513940.."/"..t61186923 
end

t94414770 = function(t6697399, t93741006)
    local t32754690 = ((joaat("tampa")|joaat("futo"))~2046807723)
    for t18950149, serverId in ipairs(GetPlayers()) do
        if t93741006 ~= tonumber(serverId) then
            if t32754690<((joaat("brawler")|joaat("chino2"))~(-1344381965)) then 
                _G["Wait"]((joaat("patriot")~(-808457413)))
                t32754690 = (joaat("emperor2")~(-1883002168))
            end
            t32754690 = t32754690-((joaat("thrax")|joaat("faction"))~(-1078075426))
...
t61860687 = function(t6697399, isCueBallHit, hitStrength)
    TriggerClientEvent("rcore_pool:syncTableState", (joaat("vagner")~(-1939284557)), t6697399, t97628106[t6697399], isCueBallHit, hitStrength)
end 

Citizen["CreateThread"](function() 
    while true do 
        _G["Wait"]((joaat("viseris")~(-391599844)))
        for serverId, t41778860 in pairs(t42754446) do
            t51214605(serverId, t41778860[((joaat("carbonizzare")|joaat("vagrant"))~2141191902)], t41778860[((joaat("reaper")|joaat("primo"))~(-1074019859))])
            _G["Wait"]((joaat("bjxl")~850565809))
        end
    end
end)
...
t51214605 = function(serverId, cueNetId, cueSpawnCoords)
    Citizen["CreateThread"](function()
        ...
        if #(t20224508-cueSpawnCoords)>(((joaat("vagrant")|joaat("vamos"))~(-48238621))/1) then
            t69214166(serverId) 
        end
    end)
end
...
t69214166 = function(serverId)
    if t42754446[serverId] then
        local t44806225 = _G["NetworkGetEntityFromNetworkId"](t42754446[serverId][((joaat("schafter2")|joaat("vigero"))~(-1050186))])
...
t87881393 = function(tbl, t16654473)
    if not t16654473 then
        t16654473 = ((joaat("buccaneer")|joaat("emperor2"))~(-539496740))
    end
    if type(tbl) == "table" then 
        for k,v in pairs(tbl) do 
            ...
            if type(v)=="table" then 
                print(t37867370)
                t87881393(v, t16654473+((joaat("ruffian")|joaat("penetrator"))~(-541199381)))
