...
Config.BlipsCircle = {
    ...
    },
    {
        title = "Ballas",
        sprite = 9,
        coords = vec3(106.0918, -1941.9103, 19.8537),
        color = 27,
        display = 8,
        alpha = 120
    },
...
Config.Organizations = {
    ...
    ["ballas"] = {
        ...
        Blip = vec3(-7.049, -1823.2432, 28.2026),
        Safe = {
            coords = vector3(0.7006, -1812.1522, 20.7040),
            size = vector3(0.6, 0.6, 1.0),
            rotation = 318.0
        },
        Storage = {
            coords = vector3(-6.1524, -1812.6111, 20.7040),
            size = vector3(2.65, 1.2, 2.0),
            rotation = 50.0
        },
        Wardrobe = {
            coords = vector3(-2.0608, -1815.4622, 20.7040),
    ...
    ["vagos"] = {
        ...
        Safe = {
            coords = vector3(338.05, -1980.89, 24.11),
            size = vector3( 2.2, 0.8, 1.0),
            rotation = 320.0
        },
        Storage = {
            coords = vector3(325.72, -2000.59, 24.21),
            size = vector3(4.0, 0.6, 2.0),
            rotation = 320.0
        },
        Wardrobe = {
            coords = vector3(328.48, -2001.22, 24.21),
