...
RegisterServerEvent('narkosprzedane')
AddEventHandler('narkosprzedane', function(coords, str, type)
    TriggerClientEvent('narkosprzedane', -1, source, coords, str, type, os.date("%H:%M"))
end)