     ...
     ESX.UI.Menu.Open(
       ...
       function(data, menu)
         ...
         if data.current.value == '1' then
           TriggerServerEvent("goat_scoreboard:server:setCode", 1) --Server event
         end
         if data.current.value == '2' then
           TriggerServerEvent("goat_scoreboard:server:setCode", 2) --Server event
         end
         if data.current.value == '3' then
           TriggerServerEvent("goat_scoreboard:server:setCode", 3) --Server event
         end
         if data.current.value == '4' then
           TriggerServerEvent("goat_scoreboard:server:setCode", 4) --Server event
         end
         menu.close()
       end,
       function(data, menu)
