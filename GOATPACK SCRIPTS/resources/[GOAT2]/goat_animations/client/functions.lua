function Animations()
            ...
            if ESX.UI.Inventory.Area.Check(3.0) then
                ESX.UI.Inventory.Area.Build(3.0, false, false, function(target, _, npc)
                    if target then
                        ...
                        TriggerServerEvent("goat_animations:requestSynced", target, data.current.keyword)
                    else
    ...
    self.PlayAnimation = function(data)
        ...
        local StartAnim = function()
            ...
            if AnimationOptions and AnimationOptions.ptfx then
                ...
                TriggerServerEvent("goat_animations:syncPtfx", PtfxAsset, PtfxName, vector3(Ptfx1, Ptfx2, Ptfx3), vector3(Ptfx4, Ptfx5, Ptfx6), PtfxBone, PtfxScale, PtfxColor)
            ...
            if AnimationOptions and AnimationOptions.ptfx and not PtfxNoProp then
                TriggerServerEvent("goat_animations:syncPtfxProp", ObjToNet(self.Entities[1].prop))
            end
    ...
    self.ClearTasks = function()
        ...
        if self.SyncedPlayer then
            ...
            TriggerServerEvent("goat_animations:stopSynced", self.SyncedPlayer)
            self.SyncedPlayer = nil
        end
    ...
    self.PlaceEntities = function()
        ...
        for i = 1, #(self.Entities) do
            ...
            TriggerServerEvent("goat_animations:CreateEntity", obj)
        end
        self.Entities = {}
        self.ClearTasks()
    end
