--- ### HANDSUP ### ---
RegisterCommand("+playHandsup", function() end)
RegisterCommand("-playHandsup", function()
    local ped = PlayerPedId()
    if DoesEntityExist(ped) and not ESX.PlayerData.dead and not IsPedInAnyVehicle(ped, false) then
...
RegisterKeyMapping("+playHandsup", "Podnieś Ręce", "keyboard", "OEM_3")
