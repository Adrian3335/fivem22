...
local WeaponRecoil = {
	...
	[`WEAPON_HEAVYPISTOL`] = 0.0,
	[`WEAPON_PISTOL50`] = 0.0,
	[`WEAPON_SNSPISTOL`] = 0.0,
	[`WEAPON_SNSPISTOL_MK2`] = 0.0,
	[`WEAPON_SMG`] = 0.0,
	[`WEAPON_ASSAULTRIFLE`] = 0.0,
	[`WEAPON_CARBINERIFLE`] = 0.0,
}
local CamPitchRecoil = {
	[`WEAPON_GLOCK`] = 0.0,
	[`WEAPON_PISTOL`] = 0.0,
	[`WEAPON_COMBATPISTOL`] = 0.0,
	[`WEAPON_HEAVYPISTOL`] = 0.0,
					...
					if IsPedShooting(playerPed) then
						...
						Citizen.CreateThread(function()
							if currentWeapon then
								...
								if(WeaponRecoil[weaponHash]) then
									ShakeGameplayCam('SMALL_EXPLOSION_SHAKE', WeaponRecoil[weaponHash])
								end
		
								if(CamPitchRecoil[weaponHash]) then
									local pitchValue = 0
									repeat 
										Citizen.Wait(0)
									...
									until pitchValue >= CamPitchRecoil[weaponHash]
								end
							end
						end)
...
RegisterNetEvent('nrp_ui:client:updateColor', function(data)
    SendNUIMessage({
        action = 'updatecolor',
        color= data,
    })
