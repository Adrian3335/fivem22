...
Config.ClothingRooms = {
    ...
    {
        job = "kawiarnia",
        coords = vector4(-586.4824, -1049.8307, 22.3442, 100.8177),
        size = vector3(2, 2, 2),
        rotation = 150,
        usePoly = false,
        points = {
            vector3(-586.4824, -1049.8307, 22.3442)
                   }
    }
}
...
Config.PlayerOutfitRooms = {
   ...
   --[[ {
        job = 'police',
        coords = vector4(356.0093, -156.0519, 73.6479, 24.1792),
        size = vector3(2, 2, 2),
        rotation = 266,
        usePoly = true,
        points = {
            vector3(356.0093, -156.0519, 73.6479),
            vector3(356.0093, -156.0519, 73.6479)
        ...
        ["Male"] = {
            {
                ...
                outfitData = {
                    ...
                    ["t-shirt"] = {item = 6, texture = 5}, -- T-Shirt
                    ["torso2"] = {item = 600, texture = 1}, -- Jackets
                    ["vest"] = {item = 0, texture = 0}, -- Vest
                    ["decals"] = {item = 0, texture = 0}, -- Decals
                    ["accessory"] = {item = 0, texture = 0}, -- Neck
                    ["bag"] = {item = 0, texture = 0}, -- Bag
                    ["pants"] = {item = 222, texture = 1}, -- Pants
