...
Config.Garages = {
    ...
    },
    {
        Visible = true,
        Type = 'car',
        Position = vector3(-61.6324, 157.0577, 81.3516),
        PedPosition = vector4(-61.6324, 157.0577, 81.3516, 119.8958),
        Model = `s_m_m_armoured_01`,
        SpawnPosition = vector4(-61.6324, 157.0577, 81.3516, 119.8958),
        Interior = 'large'
    },
 {
        Visible = false,
        Type = 'car',
        Position = vector3(601.7179, -4.6863, 70.6281),
        PedPosition = vector4(215.4677, -808.5453, 30.7597, 248.1795),
        Model = `s_m_m_armoured_01`,
        SpawnPosition = vector4(601.7179, -4.6863, 70.6281, 351.4914),
        Interior = 'large'
    },
