...
Config.Language = 'PL' -- 'EN' / 'CZ' / 'DE' / 'FR' / 'ES' / 'PT' / 'PL'
...
Config.Translate = {
    ...
    ['PL'] = {
        ...
        ["action.open_jobmenu"] = " Menu pracy",

        ["action.open_buymembership"] = "~INPUT_CONTEXT~ kup karnet",

        ['action.bench'] = " Ławka",
        ['action.pull-up'] = " Podciąganie",
        ['action.push-up'] = " Pompki",
        ['action.barbell'] = " Wolne ciężary",
        ['action.dumbbells'] = " Hantle",
        ['action.treadmill'] = " Bieżnia",
