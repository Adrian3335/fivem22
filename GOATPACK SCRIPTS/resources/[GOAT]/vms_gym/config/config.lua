...
Config.PlayerLogoutServer = "esx:playerLogout"
...
Config.Menu = 'esx_menu_default' -- 'esx_menu_default' / 'esx_context' / 'qb-menu' / 'ox_lib'
...
Config.Skillbar = function(actionName, cb)
    local finished = exports['forge-progress']:StartProg(4000)
    cb(finished)
end
