...
Config.fishingZones = {
    {
        ...
        includeOutside = true,
        message = { enter = 'Wplyneles do rafy.', exit = 'Opusciles rafe koralowa.' },
    ...
    },
    {
        ...
        message = { enter = 'Wplyneles na glebokie wody.', exit = 'Opusciles glebokie wody.' },
    ...
    },
    {
        ...
        includeOutside = true,
        message = { enter = 'Wplyneles na bagno', exit = 'Opusciles bagno' },
        fishList = { 'piranha' }
    },
}
