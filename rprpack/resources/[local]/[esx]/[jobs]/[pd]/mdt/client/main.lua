...
RegisterNetEvent('otwierajtablet')
AddEventHandler('otwierajtablet', function()
    ExecuteCommand('mdt')
end)
...
RegisterNetEvent('qf_mdt:updateLastNotes', function(notes)
...
RegisterNetEvent('qf_mdt:updatePoliceList', function(funcs)
    CLIENT.officers = {}
