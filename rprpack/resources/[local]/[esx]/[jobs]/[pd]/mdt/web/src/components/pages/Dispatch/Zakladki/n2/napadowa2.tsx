...
const Napadowa2:React.FC = () => {
    ...
    useNuiEvent<Patrol[]>('setNapadowa2', (data) => {
        setPatrolsData(data)
    })

    useNuiEvent<Status>('setNapadowa2SV', (data) => {
        setStatusData(data)
    })

    useNuiEvent<Nego>('setNapadowa2NEGO', (data) => {
        setNegoData(data)
    })

    useNuiEvent<notatkiData>('setNapadowa2Notatki', (data) => {
        setNotatkiText(data)
    })
    useNuiEvent<zadaniaData>('setNapadowa2Zadania', (data) => {
        setZadaniaText(data)
    })
    useNuiEvent<miejsceData>('setNapadowa2Miejsce', (data) => {
        setMiejsceText(data)
    })
    ...
    const setSV = (self: boolean) => {
        ...
        fetchNui('setNapadowaSV', {type: 'napadowa2', sv: sv})
    }
    ...
    const setNego = (self: boolean) => {
        ...
        fetchNui('setNapadowaNEGO', {type: 'napadowa2', nego: nego})
    }


    const clearnapadowa = () => {
        fetchNui("clearnapadowa", {})
    }

    const removePatrol = () => {
        if (clickedPatrol == null) return;
        fetchNui("removeUnit", {type: 'napadowa2', index: clickedPatrol + 1})
    }
    ...
    const submitEdit = () => {
        ...
        if (clickedPatrol === null) {
            ...
            fetchNui("createUnit", {type: 'napadowa2', unit: editedUnit, vehicle: editedVehicle, officers: officers})
        } else {
            var officers = {
                officer1: editedOfficer1,
                officer2: editedOfficer2,
            ...
            fetchNui("editUnit", {type: 'napadowa2', index: clickedPatrol + 1, unit: editedUnit, vehicle: editedVehicle, officers: officers})
        }
    }
    ...
    const ZadaniaChange = (z: string) => {
        fetchNui("updateZadaniaAkcyjna", {type: 'napadowa2', text: z})
    }

    const NotatkiChange = (z: string) => {
        fetchNui("updateNotatkiAkcyjna", {type: 'napadowa2', text: z})
    }

    const RabunekChange = (z: string) => {
        fetchNui("updateRabunekAkcyjna", {type: 'napadowa2', text: z})
    }
    ...
    return (
        <>
            ...
            <div className="napadowa2-container">
                <div className="napadowa2">
                    <TitleBlock text="napadowa 2"/>

                    <div className="napadowa2-header">
                    ...
                    <div className="napadowa2-container2">
