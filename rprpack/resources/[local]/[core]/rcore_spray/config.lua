...
Config = {
    ...
    Text = {
        ...
        SPRAY_ERRORS = {
            NOT_FLAT = 'Sciana nie jest wystarczajaco plaska',
            TOO_FAR = 'Sciana jest za daleko',
            INVALID_SURFACE = 'Nie mozesz tu namalowac',
            AIM = 'Naceluj sprayem na sciane',
        },
        NO_SPRAY_NEARBY = 'Nie ma tutaj sprayu do usuniecia',
        NEED_SPRAY = 'Nie masz sprayu przy sobie',
        WORD_LONG = 'Mozesz namalowac tylko 9 liter',
        USAGE = 'Uzycie: /spray <slowo>',
        BLACKLISTED = 'To slowo jest zakazane.'
    }
}
