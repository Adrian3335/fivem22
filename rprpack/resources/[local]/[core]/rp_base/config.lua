Config = {
	...
	DriveByUnit = "kph", -- mph | kph
	DriveBySpeed = 80,

	AppId = 1171861659808170134,
	Asset = "logo",
	AssetText = "discord.gg/twojserwer",
	PresenceText = "<name>, ID: <pid>, <players>/<maxplayers>",
    PresenceTimer = 60,
	PauseMenuTitle = "discord.gg/twojserwer",
