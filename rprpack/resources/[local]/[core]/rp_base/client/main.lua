...
RegisterNetEvent('dbl_base:adminlist')
AddEventHandler('dbl_base:adminlist', function(list)
...
CreateThread(function()
    ...
    while true do
        ESX.TriggerServerCallback("dbl_base:GetCurrentPlayers", function(players)
            ...
            SetDiscordRichPresenceAction(1, "Strona", "soon")
...
RegisterNetEvent("dbl_base:UpdateTime", function(hour2, minute2)
...
RegisterNetEvent('dbl:coords_vec3')
AddEventHandler('dbl:coords_vec3', function(args)
...
RegisterNetEvent('dbl:coords_vec4')
AddEventHandler('dbl:coords_vec4', function(args)
...
RegisterNetEvent('dbl:fix')
AddEventHandler('dbl:fix', function()
	...
	if IsPedInAnyVehicle(playerPed, false) then
		...
		exports["rp_notify"]:Notify('caron', 'Powiadomienie', "Naprawiłeś pojazd.")
	else
		exports["rp_notify"]:Notify('caroff', 'Powiadomienie', "Nie jesteś w pojezdzie!")	
	end
end)

-- Watercooler

RegisterNetEvent('dbl_epicdesk:animacja', function()
    animka1()
    Wait(3500)
...
RegisterNetEvent('dbl_use:dildo', function()
    ExecuteCommand("e używaniedildo")

end)

RegisterNetEvent('dbl_use:wheelchair', function(source)
...
RegisterNetEvent("dbl_watercooler:kup", function()
	TriggerEvent("dbl_epicdesk:animacja")
	exports['rp_ui']:Progbar('Nalewasz wody do kubeczka.', 3500)
	-- Citizen.Wait(3500)
	TriggerServerEvent("dbl_watercooler:buywater")
end)
...
CreateThread(function()
	while true do
		...
		local ped = PlayerPedId()
		if IsPedInAnyVehicle(ped, false) then
			exports['rp_ui']:UpdateTempomat(tempomat)
		else
			exports['rp_ui']:UpdateTempomat(tempomat)
			Citizen.Wait(500)
		end
...
exports['rp_base']:SpawnPed("dbl_vanillajob1", 'a_f_y_topless_01', vec4(108.5723, -1289.4388, 28.2997, 303.54864501953), {
...
exports['rp_base']:SpawnPed("dbl_vanillajob2", 'a_f_y_topless_01', vec4(104.6553, -1294.3994, 28.2997, 270.01794433594), {
    FreezeEntityPosition = true,
    SetEntityInvincible = true,
    SetBlockingOfNonTemporaryEvents = true,
}, {
...
exports['rp_base']:SpawnPed("dbl_vanillajob3", 'a_f_y_topless_01', vec4(102.1142, -1290.1742, 28.2997, 290.55752563477), {
    FreezeEntityPosition = true,
    SetEntityInvincible = true,
    SetBlockingOfNonTemporaryEvents = true,
}, {
...
exports['rp_base']:SpawnPed("kasyno", 'a_m_y_business_02', vec4(-1822.4615478516, -1201.6965332031, 13.308928489685, 1.23706054688), {
    FreezeEntityPosition = true,
    SetEntityInvincible = true,
    SetBlockingOfNonTemporaryEvents = true,
}, {
...
exports['rp_base']:SpawnPed("dbl_vanillajob4", 'cs_paper', vec4(103.4547, -1284.7019, 27.3102, 222.859375), {
    FreezeEntityPosition = true,
    SetEntityInvincible = true,
    SetBlockingOfNonTemporaryEvents = true,
}, {
...
RegisterNetEvent('dbl:wozek', function()
	local ped = PlayerPedId()
...
RegisterCommand('wozek', function()
    ...
    if IsVehicleModel(wozek, GetHashKey("iak_wheelchair")) then
        ...
        TriggerServerEvent('dbl:dodajwozek')
    else
