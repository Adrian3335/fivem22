...
AddEventHandler('sv-radialmenu:OpenClothesMenu', function()
    OpenAccessoryMenu()
end)
...
function OpenAccessoryMenu()
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'set_unset_accessory',
	{
		...
		if data.current.value == 'pants' then
			TriggerEvent('sv-radialmenu:ToggleProps', 'legs')
		elseif data.current.value == 'torso' then
			TriggerEvent('sv-radialmenu:ToggleProps', 'jackets')
            TriggerEvent('sv-radialmenu:ToggleProps', 'undershirts')
		elseif data.current.value == 'boots' then
            TriggerEvent('sv-radialmenu:ToggleProps', 'shoes')
		elseif data.current.value == 'mask' then	
			TriggerEvent('sv-radialmenu:ToggleProps', 'masks')
		elseif data.current.value == 'helmet' then	
			TriggerEvent('sv-radialmenu:ToggleProps', 'hats')
		elseif data.current.value == 'torba' then	
			TriggerEvent('sv-radialmenu:ToggleProps', 'bags')
		elseif data.current.value == 'okulary' then	
			TriggerEvent('sv-radialmenu:ToggleProps', 'glasses')
		elseif data.current.value == 'lancuch' then	
			TriggerEvent('sv-radialmenu:ToggleProps', 'neck')
		elseif data.current.value == 'zegarek' then	
			TriggerEvent('sv-radialmenu:ToggleProps', 'watches')
		elseif data.current.value == 'bransoleta' then	
			TriggerEvent('sv-radialmenu:ToggleProps', 'braclets')
		elseif data.current.value == 'kamizelka' then	
			TriggerEvent('sv-radialmenu:ToggleProps', 'vest')
		elseif data.current.value == 'uszy' then	
			TriggerEvent('sv-radialmenu:ToggleProps', 'earrings')
		end
