RegisterNetEvent('esx_garages:ThrowError', function(text)
    error(text)
end)

if Config.EnableVersionCheck then lib.versionCheck('lukewastakenn/esx_garages') end
...
lib.callback.register('esx_garages:GetVehicles', function(source, garageType, job)
...
lib.callback.register('esx_garages:GetImpound', function(source, type)
    local xPlayer = ESX.GetPlayerFromId(source)
    local identifier = xPlayer.getIdentifier()
    local vehicles = {}
...
lib.callback.register('esx_garages:CheckOwnership', function(source, plate, model, currentGarage)
    local xPlayer = ESX.GetPlayerFromId(source)
    local identifier = xPlayer.getIdentifier()
...
RegisterNetEvent('esx_garages:ChangeStored', function(plate)
...
RegisterNetEvent('esx_garages:SaveVehicle', function(vehicle, plate, ent, garage)
...
RegisterNetEvent('esx_garages:SpawnVehicle', function(model, plate, coords, heading, price)
