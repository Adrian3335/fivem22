...
const Napadowa1:React.FC = () => {
    ...
    useNuiEvent<Patrol[]>('setNapadowa1', (data) => {
        setPatrolsData(data)
    })

    useNuiEvent<Status>('setNapadowa1SV', (data) => {
        setStatusData(data)
    })

    useNuiEvent<Nego>('setNapadowa1NEGO', (data) => {
        setNegoData(data)
    })

    useNuiEvent<notatkiData>('setNapadowa1Notatki', (data) => {
        setNotatkiText(data)
    })
    useNuiEvent<zadaniaData>('setNapadowa1Zadania', (data) => {
        setZadaniaText(data)
    })
    useNuiEvent<miejsceData>('setNapadowa1Miejsce', (data) => {
        setMiejsceText(data)
    })
    ...
    const setSV = (self: boolean) => {
        ...
        fetchNui('setNapadowaSV', {type: 'napadowa1', sv: sv})
    }
    ...
    const setNego = (self: boolean) => {
        ...
        fetchNui('setNapadowaNEGO', {type: 'napadowa1', nego: nego})
    }

    const clearnapadowa = () => {
        fetchNui("clearNapadowa", {type: 'napadowa1'})
    }
    
    const removePatrol = () => {
        if (clickedPatrol == null) return;
        fetchNui("removeUnit", {type: 'napadowa1', index: clickedPatrol + 1})
    }
    ...
    const submitEdit = () => {
        ...
        if (clickedPatrol === null) {
            ...
            fetchNui("createUnit", {type: 'napadowa1', unit: editedUnit, vehicle: editedVehicle, officers: officers})
        } else {
            var officers = {
                officer1: editedOfficer1,
                officer2: editedOfficer2,
            ...
            fetchNui("editUnit", {type: 'napadowa1', index: clickedPatrol + 1, unit: editedUnit, vehicle: editedVehicle, officers: officers})
        }
    }
    ...
    const ZadaniaChange = (z: string) => {
        fetchNui("updateZadaniaAkcyjna", {type: 'napadowa1', text: z})
    }

    const NotatkiChange = (z: string) => {
        fetchNui("updateNotatkiAkcyjna", {type: 'napadowa1', text: z})
    }

    const RabunekChange = (z: string) => {
        fetchNui("updateRabunekAkcyjna", {type: 'napadowa1', text: z})
    }
    ...
    return (
        <>
            ...
            {editModal && <>
                ...
                <div className="modal-container">
                    ...
                    <div className="modal-content">
                        <input type="text" placeholder="Funkcjonariusz" onBlur={(e) => onChangeEdit('officer1', e.target.value)}></input>
                        <input type="text" placeholder="Funkcjonariusz" onBlur={(e) => onChangeEdit('officer2', e.target.value)}></input>
                        <input type="text" placeholder="Funkcjonariusz" onBlur={(e) => onChangeEdit('officer3', e.target.value)}></input>
                        <input type="text" placeholder="Funkcjonariusz" onBlur={(e) => onChangeEdit('officer4', e.target.value)}></input>
                        <input type="text" placeholder="Funkcjonariusz" onBlur={(e) => onChangeEdit('officer5', e.target.value)}></input>
            ...
            <div className="napadowa-container">
                <div className="napadowa">
                    <TitleBlock text="Napadowa 1"/>

                    <div className="napadowa-header">
                    ...
                    <div className="napadowa-container2">
